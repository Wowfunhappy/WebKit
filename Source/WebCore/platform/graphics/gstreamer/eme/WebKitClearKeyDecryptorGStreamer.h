...
// MAVERICKS_BACKPORT: upstream's ClearKey decryptor element, removed in 4694d7d ("[WPE][GTK] Enable
// Thunder and remove old Clearkey CDM/Decryptor"). macOS has no Thunder, so this element is what
// gives the GStreamer pipeline a "webkitclearkey" decryptor. See CDMProxyClearKey.h.
