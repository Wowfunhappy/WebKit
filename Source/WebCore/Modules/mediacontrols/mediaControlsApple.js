...
Controller.prototype = {
    ...
    createControls: function()
    {
        ...
        panel.setAttribute('useragentpart', '-internal-media-controls-panel');
        ...
        rewindButton.setAttribute('useragentpart', '-internal-media-controls-rewind-button');
        ...
        seekBackButton.setAttribute('useragentpart', '-internal-media-controls-seek-back-button');
        ...
        seekForwardButton.setAttribute('useragentpart', '-internal-media-controls-seek-forward-button');
        ...
        playButton.setAttribute('useragentpart', '-internal-media-controls-play-button');
        ...
        statusDisplay.setAttribute('useragentpart', '-internal-media-controls-status-display');
        statusDisplay.classList.add(this.ClassNames.hidden);

        var timelineBox = this.controls.timelineBox = document.createElement('div');
        timelineBox.setAttribute('useragentpart', '-internal-media-controls-timeline-container');

        var currentTime = this.controls.currentTime = document.createElement('div');
        currentTime.setAttribute('useragentpart', '-internal-media-controls-current-time-display');
        ...
        timeline.setAttribute('useragentpart', '-internal-media-controls-timeline');
        ...
        remainingTime.setAttribute('useragentpart', '-internal-media-controls-time-remaining-display');
        ...
        muteButton.setAttribute('useragentpart', '-internal-media-controls-mute-button');
        ...
        minButton.setAttribute('useragentpart', '-internal-media-controls-volume-min-button');
        ...
        maxButton.setAttribute('useragentpart', '-internal-media-controls-volume-max-button');
        ...
        volume.setAttribute('useragentpart', '-internal-media-controls-volume-slider');
        ...
        fullscreenButton.setAttribute('useragentpart', '-internal-media-controls-fullscreen-button');
    ...
    buildCaptionMenu: function()
    {
        ...
        this.captionMenu.setAttribute('useragentpart', '-internal-media-controls-closed-captions-container');
