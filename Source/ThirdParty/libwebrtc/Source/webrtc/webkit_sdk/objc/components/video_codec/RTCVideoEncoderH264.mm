...
#include "webkit_sdk/WebKit/VideoProcessingSoftLink.h"
#include "webkit_sdk/WebKit/WebKitUtilities.h"
...
- (int)resetCompressionSessionWithPixelFormat:(OSType)framePixelFormat {
  ...
  CFDictionarySetValue(encoderSpecs, kVTVideoEncoderSpecification_EnableHardwareAcceleratedVideoEncoder, kCFBooleanTrue);
