...
# MAVERICKS_BACKPORT: Cocoa upstream builds with the isolated AX tree on; the CMake-port default
# (WebKitFeatures.cmake) leaves it off only because no Apple CMake port exercised it. Building it
# matches upstream source shape (WebAccessibilityObjectWrapperBase.mm needs no local guard). At
# runtime it stays dormant: activation requires libAccessibility's _AXSIsolatedTreeMode (a MAY_FAIL
# soft-link), which this OS does not ship.
