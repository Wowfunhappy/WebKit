/*
 * Minimal support header for the shared/ libc gap-fills vendored from MacPorts.
 *
 * Upstream macports-legacy-support must detect the SDK and target OS
 ...
 * from MacPorts with their version gating stripped out.
 *
