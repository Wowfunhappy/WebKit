// libcompression: Apple libcompression (10.11+), absent on 10.9 in its entirety
// (/usr/lib/libcompression.dylib does not exist). Also carries crc32_z for /usr/lib/libz.dylib.
//
