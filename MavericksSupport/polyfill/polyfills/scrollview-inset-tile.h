...
// polyfill proper (methods.m, which wires it to WebKit's -contentInsets / -setContentInsets: sends) and
// its proof, tests/wk_scrollview_insets.m — so the probe exercises the very code WebKit runs.
//
