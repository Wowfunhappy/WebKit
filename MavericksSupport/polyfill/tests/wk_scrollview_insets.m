...
// -contentInsets / -setContentInsets: sends by methods.m): wkScrollViewSetContentInsets re-classes the
...
int main(void)
{
    ...
    if (failures) {
        fprintf(stderr, "wk_scrollview_insets: %d failure(s)\n", failures);
        return 1;
    }
    printf("wk_scrollview_insets: all checks passed\n");
    return 0;
}
