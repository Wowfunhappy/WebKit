...
WEBCORE_EXPORT bool holdsResponseForSniffing(const String& mimeType);
WEBCORE_EXPORT String computeHTTPMIMEType(std::span<const uint8_t>, const String& mimeType, const String& contentType, bool noSniff);
