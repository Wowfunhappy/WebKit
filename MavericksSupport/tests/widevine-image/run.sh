#!/bin/bash
# Exercises the Mach-O work WebKit does on Google's Widevine module
# (Source/WebKit/UIProcess/mac/WidevineCdmImage.cpp) against real files on this host.
#
...
print(compile + " -c " + shlex.quote(repo + "/Source/WebKit/UIProcess/mac/WidevineCdmImage.cpp") + " -o " + shlex.quote(work + "/image.o"))
print(compile + " -x objective-c++ -fno-objc-arc -c " + shlex.quote(repo + "/Source/WebKit/UIProcess/mac/WidevineCdmArchive.mm") + " -o " + shlex.quote(work + "/archive.o"))
